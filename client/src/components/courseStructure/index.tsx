...
import { mtechSem1, mtechSem2, mtechSem3, mtechSem4 } from './mtech'
import { beYear1, beYear2, beYear3, beYear4 } from './be'
...
const BtechCourseStructure: React.FC<IProps> = ({ course, semYear }) => {
...
export default BtechCourseStructure
