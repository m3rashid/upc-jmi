      ...
      <Timeline active={7} bulletSize={30} lineWidth={5}>
        ...
        >
          <Text color="dimmed" size="md">
            ...
            institution originally established by a group of Muslim nationalists
            and intellectuals at Aligarh, Uttar Pradesh during the Khilafat and
            Non-Cooperate movement in response to Mahatma Gandhi’s step to
            boycott government-supported education system
          </Text>
        </Timeline.Item>
        ...
        >
          <Text color="dimmed" size="md">
            ...
            then, it has been continuously growing, always renewing its methods
            and preparing itself from time to time to meet new needs. Loyal to
            its ideals, it has over the years, tried to enhance the physical and
            mental development of students, and has become a premier educational
        ...
        >
          <Text color="dimmed" size="md">
            Jamia Millia Islamia was declared a Deemed University under Section
            2 of the University Grants Commission(UGC) Act in 1962
          </Text>
        </Timeline.Item>
        <Timeline.Item
        ...
        >
          ...
          <Text color="dimmed" size="md">
            In 1985, it established the Faculty of Engineering & Technology and
            the University Computer Centre. Academic Staff College and the
          ...
          <Text color="dimmed" size="md">
            Many new courses and programmes at UG and PG levels have since been
            added.
          </Text>
        </Timeline.Item>
        <Timeline.Item
        ...
        >
          <Text color="dimmed" size="md">
            Jamia Millia Islamia became a Central University in the year 1988 by
            an act of the Indian Parliament which was passed on December 26,
            1988
          </Text>
        </Timeline.Item>
        <Timeline.Item
        ...
        >
          <Text color="dimmed" size="md">
            ...
            offers various undergraduate and postgraduate IT courses. Apart from
            this, the Jamia has a campus-wide network which connects a large
            number of its departments and offices.
          </Text>
        </Timeline.Item>
        <Timeline.Item bullet={<Snowflake size={iconSize} />} title="Jamia Now">
          <Text color="dimmed" size="md">
            ...
            specialized areas—is a saga of dedication, conviction, and vision of
            a people who worked against all odds and nurtured it growth step by
            step.
          </Text>
        </Timeline.Item>
      </Timeline>
