      ...
      <Timeline active={7} bulletSize={30} lineWidth={5}>
        ...
        <Timeline.Item bullet={<Sun size={iconSize} />} title="">
          <Text color="dimmed" size="md">
            ...
            member of the Computer Society of India, and has an active student's
            ...
            Linux user group here at the department which is also actively
            making efforts to improve the student's skills in Linux.
          </Text>
        </Timeline.Item>
      </Timeline>
    </div>
