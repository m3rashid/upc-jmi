  ...
  return (
    <div className={classes.themeColor}>
      ...
      <Timeline active={7} bulletSize={30} lineWidth={5}>
        <Timeline.Item bullet={<Sun size={iconSize} />} title="Started in 2000">
          <Text color="dimmed" size="md">
            The Department of Computer Engineering was started in the year 2000.
            Since its inception, the department has kept on evolving and now has
            become one of the leading departments at the Faculty of Engineering
            and Technology.
          </Text>
        </Timeline.Item>
        <Timeline.Item bullet={<Sun size={iconSize} />} title="UG Courses">
          <Text color="dimmed" size="md">
            ...
            B.Tech in Computer Engineering and B.E. in Computer Engineering, B.
          </Text>
        </Timeline.Item>
        <Timeline.Item bullet={<Sun size={iconSize} />} title="Academics">
          <Text color="dimmed" size="md">
            ...
            students market ready. Department of Computer Engineering also runs
            Masters program that has thrust on research in AI, NLP, Soft
        ...
        <Timeline.Item bullet={<Sun size={iconSize} />} title="Market Trends">
          <Text color="dimmed" size="md">
            ...
            are working in the fields of Networking, Data Mining, and Artificial
            Intelligence etc
          </Text>
        </Timeline.Item>
        <Timeline.Item
        ...
        >
          <Text color="dimmed" size="md">
            ...
            also authored a number of books in the field of Computer Engineering
            and are actively involved in taking the department to greater
            heights.
          </Text>
        </Timeline.Item>
        ...
        <Timeline.Item bullet={<Sun size={iconSize} />} title="Placements">
          <Text color="dimmed" size="md">
            ...
            from TCS. With the visit from other companies, most of the students
            of the department have been placed. Companies like TCS, HCL, HP,
            Adobe, Arricent, Accenture, BirlaSoft, NewGen etc. have visited the
        ...
        <Timeline.Item bullet={<Sun size={iconSize} />} title="">
          <Text color="dimmed" size="md">
            ...
            cultural cum technical fest and various other events throughout the
            year. We also have a Linux user group here at the department which
            is also actively making efforts to improve the student&apos;s skills
            in Linux.
          </Text>
        </Timeline.Item>
      </Timeline>
